...
const PLAN = {
  ...
  6: {
    ...
    color: "#ca8a04",
    topics: [
      { topic: "LIVE: Ask the coach anything", hook: "Bring your toughest health question — going LIVE at 6 PM!" },
      { topic: "LIVE: Build your personal meal plan", hook: "Tonight we build YOUR plan together — join free at 6 PM." },
      { topic: "LIVE: Myth-busting nutrition Q&A", hook: "Everything you were told about food might be wrong. LIVE 6 PM." },
      { topic: "LIVE: 7-day reset challenge kickoff", hook: "Start your 7-day reset with me — LIVE tonight at 6 PM!" },
      { topic: "LIVE: Success stories & transformations", hook: "Real people, real results — get inspired LIVE at 6 PM." },
    ],
  },
  0: {
    key: "community",
